exports.createProject = function(app, mongoose, request, response, callback) {
...
Project.find({deleted : 'false'}).sort([['name', 'ascending']]).exec(function(err, projects) {
		if (err) {
			return console.error(err);
		}
		if (callback === undefined) {
...
exports.getProject = function(app, mongoose, request, response, callback) {
...
exports.addChild = function(app, mongoose, request, response, callback) {
	var Project = mongoose.model('Project', app.projectSchema);
