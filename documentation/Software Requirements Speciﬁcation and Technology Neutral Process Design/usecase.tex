...
The scope of the Project module is shown in the figure below
	\begin{figure}[H]
	    	\centering
	    	\fbox{\includegraphics[width=0.5\textwidth]{projectScope}}
...
\begin{itemize}
	...
	\begin{figure}[H]
    	\centering
    	\fbox{\includegraphics[width=0.5\textwidth]{servicesContractcreateProject}}
...
\begin{itemize}
	...
	\begin{figure}[H]
    	\centering
    	\fbox{\includegraphics[width=0.5\textwidth]{servicesContractgetProject}}
